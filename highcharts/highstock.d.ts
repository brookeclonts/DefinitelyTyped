...
interface ChartObject extends Hc.ChartObject {
    options: Options;
}
...
declare global {
    interface JQuery {
        highcharts(type: "StockChart"): ChartObject;
        /**
         ...
         **/
        highcharts(type: "StockChart", options: Options): JQuery;
        /**
         * Creates a new Highcharts.Chart for the current JQuery selector; usually
         * a div selected by $('#container')
         * @param {Options} options Options for this chart
         ...
         * @return current {JQuery} selector the current JQuery selector
         **/
        highcharts(type: "StockChart", options: Options, callback: (chart: ChartObject) => void): JQuery;
